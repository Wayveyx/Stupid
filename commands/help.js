...
.addField('Misc. Commands', '**sb;request** - Request a command you think should be added.\n**sb;support** - Talk to the Support Server (One way).\n**sb;invite** - Add me to your server.\n**sb;avatar** - My Avatar.\n**sb;myavatar** - Your avatar.\n**sb;sicon** - Server icon.')
...
.setFooter('The help command is being redone and all commands may not be shown.'));                                                                                 //i want to die because of the 2 commands above this text  
